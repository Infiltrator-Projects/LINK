...
static const LinkObd2ParameterEntry link_obd2_parameters[] = {
    ...
    { { OBD_KEY(0x06U), "obd2.pid.06", "PID 06", "Short term fuel trim - Bank 1", "%", 1U, false, -100, 99.2 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x07U), "obd2.pid.07", "PID 07", "Long term fuel trim - Bank 1", "%", 1U, false, -100, 99.2 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x08U), "obd2.pid.08", "PID 08", "Short term fuel trim - Bank 2", "%", 1U, false, -100, 99.2 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x09U), "obd2.pid.09", "PID 09", "Long term fuel trim - Bank 2", "%", 1U, false, -100, 99.2 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x0aU), "obd2.pid.0a", "PID 0A", "Fuel pressure (gauge pressure)", " kPa", 1U, false, 0, 765 }, LINK_OBD2_UNIT_KPA },
    { { OBD_KEY(0x22U), "obd2.pid.22", "PID 22", "Fuel rail pressure (relative to manifold vacuum)", " kPa", 1U, false, 0, 5177.265 }, LINK_OBD2_UNIT_KPA },
    { { OBD_KEY(0x2eU), "obd2.pid.2e", "PID 2E", "Commanded evaporative purge", "%", 1U, true, 0, 100 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x3dU), "obd2.pid.3d", "PID 3D", "Catalyst temperature - Bank 2, Sensor 1", " °C", 1U, false, -40, 6513.5 }, LINK_OBD2_UNIT_CELSIUS },
    { { OBD_KEY(0x3fU), "obd2.pid.3f", "PID 3F", "Catalyst temperature - Bank 2, Sensor 2", " °C", 1U, false, -40, 6513.5 }, LINK_OBD2_UNIT_CELSIUS },
    { { OBD_KEY(0x43U), "obd2.pid.43", "PID 43", "Absolute load value", "%", 1U, false, 0, 25700 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x44U), "obd2.pid.44", "PID 44", "Commanded air-fuel equivalence ratio (lambda)", "", 4U, false, 0, 1.999 }, LINK_OBD2_UNIT_RATIO },
    { { OBD_KEY(0x4eU), "obd2.pid.4e", "PID 4E", "Time since trouble codes cleared", " min", 0U, false, 0, 65535 }, LINK_OBD2_UNIT_MINUTES },
    { { OBD_KEY(0x50U), "obd2.pid.50", "PID 50", "Maximum value for air flow rate from mass air flow sensor (only A used; B, C, D reserved)", " g/s", 2U, false, 0, 2550 }, LINK_OBD2_UNIT_GRAMS_PER_SECOND },
    { { OBD_KEY(0x52U), "obd2.pid.52", "PID 52", "Ethanol fuel percentage", "%", 1U, true, 0, 100 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x53U), "obd2.pid.53", "PID 53", "Absolute evaporative system vapor pressure", " kPa", 1U, false, 0, 327.675 }, LINK_OBD2_UNIT_KPA },
    { { OBD_KEY(0x59U), "obd2.pid.59", "PID 59", "Fuel rail absolute pressure", " kPa", 1U, false, 0, 655350 }, LINK_OBD2_UNIT_KPA },
    { { OBD_KEY(0x5aU), "obd2.pid.5a", "PID 5A", "Relative accelerator pedal position", "%", 1U, true, 0, 100 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x5bU), "obd2.pid.5b", "PID 5B", "Hybrid battery pack remaining life", "%", 1U, true, 0, 100 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x61U), "obd2.pid.61", "PID 61", "Driver's demand engine percent torque", "%", 1U, false, -125, 130 }, LINK_OBD2_UNIT_PERCENT },
    { { OBD_KEY(0x62U), "obd2.pid.62", "PID 62", "Actual engine percent torque", "%", 1U, false, -125, 130 }, LINK_OBD2_UNIT_PERCENT },
