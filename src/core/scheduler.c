...
LinkSchedulerResult link_scheduler_configure_standard_obd2_bits(LinkScheduler *scheduler, const uint8_t supported_bits[LINK_OBD2_PID_SET_BYTES], uint64_t first_due_ms)
{
    static const StandardSchedule plan[] = {
        { 0x0cU, 250U, LINK_SCHEDULER_PRIORITY_CRITICAL },
        ...
        { 0x7aU, 750U, LINK_SCHEDULER_PRIORITY_HIGH },
        { 0x7cU, 1000U, LINK_SCHEDULER_PRIORITY_HIGH },
        { 0x11U, 500U, LINK_SCHEDULER_PRIORITY_HIGH },
        { 0x04U, 750U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x10U, 750U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x2cU, 750U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x2dU, 1000U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x45U, 750U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x47U, 750U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x48U, 750U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x4bU, 750U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x5eU, 1000U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x78U, 1000U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x3cU, 1500U, LINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x05U, 1500U, LINK_SCHEDULER_PRIORITY_LOW },
        { 0x0fU, 1500U, LINK_SCHEDULER_PRIORITY_LOW },
        { 0x33U, 2000U, LINK_SCHEDULER_PRIORITY_LOW },
        { 0x42U, 2000U, LINK_SCHEDULER_PRIORITY_LOW },
        { 0x46U, 3000U, LINK_SCHEDULER_PRIORITY_LOW },
        { 0x5cU, 1500U, LINK_SCHEDULER_PRIORITY_LOW }
    };
    size_t index;
