...
static const LinkMercedesMeDataIdDefinition mercedes_me_data_ids[] = {
...
const LinkMercedesMeDataIdDefinition *link_mercedes_me_data_id_at(size_t index)
{
    return index < link_mercedes_me_data_id_count()
