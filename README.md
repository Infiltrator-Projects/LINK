...
Bare-metal STM32 support keeps STM32Cube HAL outside the portable core: the host-tested queue/transaction glue lives in `platform/stm32`, while concrete Cube integration stays in `examples/stm32c092` for FDCAN and `examples/stm32-bxcan` for STM32F103/F107/F767. See `docs/STM32.md`.
