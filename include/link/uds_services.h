...
/*
 * ECUReset capability bits for the reset actions that actually restart the
 * ECU. Rapid-power-shutdown 0x04/0x05 is a separate state-changing feature,
 * not an ECU restart.
 */
#define LINK_UDS_ECU_RESET_SUPPORT_HARD UINT8_C(0x01)
#define LINK_UDS_ECU_RESET_SUPPORT_KEY_OFF_ON UINT8_C(0x02)
#define LINK_UDS_ECU_RESET_SUPPORT_SOFT UINT8_C(0x04)
#define LINK_UDS_ECU_RESET_SUPPORT_ALL_RESETS UINT8_C(0x07)
