...
static const char link_gtk_base_css[] =
    ...
    ".link-nav-row { margin: 3px 8px; padding: 6px 8px; border-radius: 6px; border: 1px solid transparent; background: transparent; }"
    ...
    ".link-content-summary { opacity: 0.76; font-size: 12px; }"
