...
int main(void)
{
    ...
    link_i18n_init();
    passed &= check(link_i18n_supported_locale_count() == 7U,
    ...
    passed &= check(strcmp(link_i18n_supported_locale(6U), "pl-PL") == 0,
                    "Polish locale registry mismatch");
    passed &= check(strcmp(link_i18n_supported_locale_name(6U), "Polski") == 0,
